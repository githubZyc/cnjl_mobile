...
var linum=$("#wrapper li").length;
	$("#wrapper ul").css("width",58*linum+"px");
	new IScroll('#wrapper', { scrollX: true, scrollY: false, mouseWheel: true,scroll:function(e){
		console.dir(e);
	}});
	new Swipe(document.getElementById('bannermain'), {
				speed:500,
				auto:3000,
				callback: function(){
					var lis = $(".banner_bt").children();
					
					lis.removeClass("now").eq(this.index).addClass("now");
				}
	});