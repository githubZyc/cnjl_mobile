(function($, window) {
	...
	var PreviewImage = function(options) {
		this.options = $.extend(true, {
			...
			zoom: true,
			header: '<a style="color:#fff" class="mui-action-back mui-icon mui-icon-left-nav mui-pull-left"></a><span class="mui-preview-indicator"></span>',
			footer: '<ul class="mui-table-view" style="z-index:1999;background:rgba(0,0,0,.8);position:absolute;bottom:0;"><li class="mui-table-view-cell mui-media"><a href="javascript:;" style="color:#fff"><div class="mui-media-object mui-pull-left">		<img class="" src="../../images/order_manage_07.png">	</div><div class="mui-media-body" style="color:#fff">	小小小柠檬	<div class="icons mui-inline">		<i data-index="1" class="mui-icon mui-icon-star mui-icon-star-filled"></i>		<i data-index="2" class="mui-icon mui-icon-star mui-icon-star-filled"></i>		<i data-index="3" class="mui-icon mui-icon-star mui-icon-star-filled"></i>		<i data-index="4" class="mui-icon mui-icon-star"></i>		<i data-index="5" class="mui-icon mui-icon-star"></i>	</div>	<p style="color:#fff">高端大气上档次，这是要买买是要买买是要买买买的节奏么……</p></div></a></li></ul>'
		}, options || {});
		this.init();
		this.initEvent();
	};
